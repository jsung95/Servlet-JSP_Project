							...
							<div class="col-8 col-12-medium">
								...
								<!-- Content -->
									<section id="content">
										...
										<section id="editdel">
											<span> 
												<a href="/Woosuk/controller/modifyBoard?id=<%=boards.get(boards.size()-1).getId() %>" class="button primary">수정</a> 
											</span>
											<span>
												<a href="/Woosuk/controller/deleteBoard?id=<%=boards.get(boards.size()-1).getId() %>"class="button primary">삭제</a>
											</span>
